    ...
    <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="bg-gray-800 rounded-lg shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-4 border-b border-gray-700">
          <h2 className="text-xl font-bold text-white">About VidFlo</h2>
        ...
        <div className="p-6 overflow-y-auto text-gray-300 space-y-4">
          <p>
            Welcome to VidFlo, a library of high-quality, royalty-free video clips designed for an instant creative workflow.
          </p>
          <p>
